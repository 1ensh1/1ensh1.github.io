...
const ASSESSMENTS = [
   ...
   { key: 'f4', label: 'Formative 4', file: 'data/formative4.json', icon: '📝', type: 'formative' },
    ...
    { key: 'sw3', label: 'Seatwork 3', file: 'data/seatwork3.json', icon: '📝', type: 'seatwork' },
    { key: 'sw4', label: 'Seatwork 4', file: 'data/seatwork4.json', icon: '📝', type: 'seatwork' },
];
...
const SECTIONS = [
    ...
    { type: 'seatwork',  label: 'Seatwork',              subtitle: 'In-class practice exercises'                   },
